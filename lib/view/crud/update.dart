...
class _UpdateState extends State<Update> {
  TextEditingController idshrimps = TextEditingController();
  ...
  submit() async {
    ...
    var ids = int.parse(idshrimps.text);
    ...
    var responseApi =
        await dio.patch('$baseUrlApi/shrimps/$ids', data: uploadDataData);
